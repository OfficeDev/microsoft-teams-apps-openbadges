...
import { getResourceStrings } from "../api/open-badges-api";
...
export default class ErrorPage extends React.Component<{}, errorPageState> {
    ...
    constructor(props: any) {
        ...
        this.state = {
            ...
            resourceStrings:
            {
                ...
                InvalidTenant: "You are not authorized to access this Bot. Please contact administrator.",
                SessionExpired: "Your session has expired. Please sign in again to proceed."
            }
        };
    }
  ...
  * */
    ...
    render() {
        let message = this.state.resourceStrings.InvalidTenant;
        ...
        return (
            <Provider theme={this.state.themeStyle}>
                <div className="container-div">
                    <Flex gap="gap.small" hAlign="center" vAlign="center" styles={{ paddingTop: "30vh" }}>
